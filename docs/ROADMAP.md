...
| Browser matrix ✅ 冒烟已实施（2026-08-28，E-4 第一批；完整矩阵未实施） | 主题、键盘调栏、200% 缩放、系统 Edge/Chromium。已交付 chromium 冒烟：纯键盘审批流 + 终局卡片基线截图 + optional e2e-smoke workflow，细节见 [`PLAN-stage-e-2026-08-27.md`](PLAN-stage-e-2026-08-27.md) E-4 章 | 可重复 GUI 测试与真实截图，不用源码字符串代替渲染验证（冒烟已达标：两连跑逐字节一致、CI 首跑全绿） |
