# RFC · agent 自动 retry 的预算约束(已实施关闭)

> 状态:**已实施关闭(2026-08-27,批次 K 落地)**。2026-08-23 草案;2026-08-27
> 用户裁定:**采纳**选项 A 的承诺确认与选项 C 的 dry-run 警告,**否决**选项
> B 的准入硬拦(不予实施)。批次 K 已交付:承诺句式落档(README×2/skill/
> concepts/CHANGELOG)+ `_dry_run_warnings` 组合警告(含 Web preview 同源
> 透出)与正反例、合并、反向验证测试。默认行为除新增警告外无变化
> (retry 缺省已是 0)。背景:2026-08-19 阶段 D 的 $10.508 事故——
...
## 实施清单(批次 K,先于 Stage E 各项;设计细节见 PLAN-stage-e-2026-08-27.md 批次 K 节)✅ 已全部落地(2026-08-27)
